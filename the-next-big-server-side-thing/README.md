...
3. Build a Docker image: `sudo docker build -t the-next-big-server-side-thing .`
4. Run your Docker image: `docker run -p 8080:8080 the-next-big-server-side-thing`
